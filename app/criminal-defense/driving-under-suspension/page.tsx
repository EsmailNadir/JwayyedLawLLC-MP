...
export const metadata: Metadata = {
  title: 'Driving Under Suspension Ohio | Jwayyed Law LLC',
  description: 'Ohio driving under suspension defense attorney for ORC 4510.11, 4510.14, and 4510.16 charges statewide. Call (614) 285-5482.',
  keywords: [
...
export default function DrivingUnderSuspensionPage() {
  ...
  return (
    <>
      ...
      <PageHero
        title="Driving Under Suspension Defense in Ohio"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">General Driving Under Suspension (ORC 4510.11)</h4>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">General DUS Penalties (ORC 4510.11)</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">OVI-Related DUS Penalties (ORC 4510.14)</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">FRA DUS Penalties (ORC 4510.16)</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Collateral Consequences of DUS Convictions</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Arrest or Citation and Arraignment</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Pretrial Motions and Negotiation</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Trial and Sentencing</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
