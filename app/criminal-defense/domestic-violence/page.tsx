...
export const metadata: Metadata = {
  ...
  description: 'Experienced Columbus domestic violence defense attorney protecting your rights. Skilled representation for domestic violence charges, protection orders, and related offenses in Ohio. Free consultation: (614) 285-5482',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Experienced domestic violence defense representation in Columbus and throughout Ohio. Free consultation available.',
