        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Basic Speeding (ORC 4511.21)</h4>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">How Points Work in Ohio</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Speeding Point Values</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Fines and Court Costs</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Insurance Rate Impacts</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Initial Citation and Court Date</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Arraignment and Plea</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Discovery and Evidence Review</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Negotiation and Resolution</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              <h4 className="font-semibold text-gray-900 group-hover:text-[#b87333] transition-colors mb-4">Radar/Lidar Calibration Challenges</h4>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors mb-4">
