...
export const metadata: Metadata = {
  title: 'Montgomery County Criminal Defense & OVI Lawyer | Jwayyed Law LLC',
  description:
    'Jwayyed Law LLC defends OVI, criminal misdemeanor, and personal injury cases in Montgomery County — Dayton, Kettering, Huber Heights, Trotwood, and surrounding communities. Dayton Municipal Court. Call (614) 285-5482.',
  keywords: [
