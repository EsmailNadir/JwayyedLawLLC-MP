...
export const metadata: Metadata = {
  title: 'Criminal Misdemeanor Defense Lawyer for Dayton, Ohio | Dayton & Kettering Municipal Courts | Jwayyed Law LLC',
  description: 'Experienced criminal misdemeanor defense attorney for Dayton, Kettering, Huber Heights, and Montgomery County, Ohio. Dayton Municipal Court and Kettering Municipal Court. Call (614) 285-5482.',
