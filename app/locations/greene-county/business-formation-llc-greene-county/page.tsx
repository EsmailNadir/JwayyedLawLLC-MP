...
export const metadata: Metadata = {
  title: 'Business & LLC Formation | Greene County, Ohio | Jwayyed Law LLC',
...
export default function BusinessFormationLLCGreeneCountyPage() {
  const locationSchema = {"@context": "https://schema.org", "@type": "LegalService", "name": "Jwayyed Law LLC — Business Formation and LLC in Greene County", "serviceType": "Business Law", "areaServed": {"@type": "County", "name": "Greene County", "containedInPlace": {"@type": "State", "name": "Ohio"}}, "provider": {"@type": "LegalService", "@id": "https://www.jjlawohio.com", "name": "Jwayyed Law LLC", "telephone": "(614) 285-5482", "url": "https://www.jjlawohio.com"}, "url": "https://www.jjlawohio.com/locations/greene-county/business-formation-llc-greene-county"};
