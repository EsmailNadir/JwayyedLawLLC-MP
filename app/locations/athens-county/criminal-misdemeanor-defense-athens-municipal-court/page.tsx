...
export const metadata: Metadata = {
  ...
  description: 'Experienced criminal misdemeanor defense attorney in Athens County - Athens Municipal Court. Skilled representation for misdemeanor charges in Athens County, Ohio. Free consultation: (614) 285-5482',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes, misdemeanors may be eligible for expungement in Athens County under Ohio Revised Code 2953.31 after completing sentence requirements and waiting periods. Eligibility depends on offense type, prior convictions, and circumstances. An attorney can help determine eligibility and file expungement petitions.',
  },
  {
