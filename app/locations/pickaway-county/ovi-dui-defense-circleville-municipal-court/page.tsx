...
export const metadata: Metadata = {
  title: 'OVI Defense Lawyer | Circleville Municipal Court | Jwayyed Law LLC',
...
export default function PickawayOVIDefensePage() {
  const locationSchema = {"@context": "https://schema.org", "@type": "LegalService", "name": "Jwayyed Law LLC — OVI/DUI Defense in Pickaway County", "serviceType": "OVI DUI Defense", "areaServed": {"@type": "County", "name": "Pickaway County", "containedInPlace": {"@type": "State", "name": "Ohio"}}, "provider": {"@type": "LegalService", "@id": "https://www.jjlawohio.com", "name": "Jwayyed Law LLC", "telephone": "(614) 285-5482", "url": "https://www.jjlawohio.com"}, "url": "https://www.jjlawohio.com/locations/pickaway-county/ovi-dui-defense-circleville-municipal-court"};
