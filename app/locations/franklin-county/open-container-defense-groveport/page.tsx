...
export const metadata: Metadata = {
  ...
  description: 'Criminal defense attorney serving Groveport, Ohio. Assault, domestic violence, drug, and theft charges — Franklin County Municipal Court. (614) 285-5482.',
