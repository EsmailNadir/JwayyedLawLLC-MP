...
export const metadata: Metadata = {
  title: 'Groveport Disorderly Conduct Defense | Jwayyed Law',
  description: 'Disorderly conduct charge in Groveport? R.C. 2917.11. Groveport Mayor\'s Court. Jwayyed Law LLC. Call (614) 285-5482.',
...
export default function GroveportDisorderlyPage() {
  return <DisorderlyConductTemplate suburb="Groveport" />;
}
