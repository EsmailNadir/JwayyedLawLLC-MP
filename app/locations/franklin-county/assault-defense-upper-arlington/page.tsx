...
export const metadata: Metadata = {
  ...
  description: 'Criminal defense attorney in Upper Arlington, Ohio — assault, domestic violence, drug & theft charges. Franklin County Municipal Court. (614) 285-5482.',
