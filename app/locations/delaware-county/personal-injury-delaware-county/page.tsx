...
export const metadata: Metadata = {
  title: 'Delaware County Personal Injury Attorney | Jwayyed Law LLC',
  description: 'Personal injury attorney serving Delaware County, Ohio. Delaware, Powell, Dublin, Lewis Center. Car accidents, slip and fall. Call (614) 285-5482.',
...
export default function PersonalInjuryDelawareCountyPage() {
  const locationSchema = {"@context": "https://schema.org", "@type": "LegalService", "name": "Jwayyed Law LLC — Personal Injury in Delaware County", "serviceType": "Personal Injury", "areaServed": {"@type": "County", "name": "Delaware County", "containedInPlace": {"@type": "State", "name": "Ohio"}}, "provider": {"@type": "LegalService", "@id": "https://www.jjlawohio.com", "name": "Jwayyed Law LLC", "telephone": "(614) 285-5482", "url": "https://www.jjlawohio.com"}, "url": "https://www.jjlawohio.com/locations/delaware-county/personal-injury-delaware-county"};
