...
export const metadata: Metadata = {
  ...
  description: 'Experienced legal representation in Wilmington Municipal Court. Skilled representation for misdemeanor cases, OVI/DUI, and traffic violations in Clinton County, Ohio. Free consultation: (614) 285-5482',
...
const faqs = [
  {
    ...
    answer: 'Wilmington Municipal Court handles misdemeanor criminal cases, OVI/DUI charges, traffic violations, civil disputes involving amounts up to $15,000, small claims matters, and landlord-tenant disputes occurring in Clinton County. The court follows Ohio Revised Code for procedures and penalties.',
  },
  {
    question: 'Where is Wilmington Municipal Court located?',
    answer: 'Wilmington Municipal Court is located in Wilmington, Ohio. The court handles all misdemeanor cases, OVI/DUI charges, and traffic violations occurring in Clinton County. An attorney familiar with the court can help navigate procedures and achieve favorable outcomes.',
  },
  {
