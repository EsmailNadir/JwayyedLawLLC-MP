...
export const metadata: Metadata = {
  ...
  description: 'Experienced legal representation in Athens County courts including Common Pleas and Athens Municipal Court. Skilled representation in Athens County, Ohio. Free consultation: (614) 285-5482',
