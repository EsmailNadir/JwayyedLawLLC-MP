...
export const metadata: Metadata = {
  title: 'Xenia Municipal Court Attorney | Greene County Lawyer | Jwayyed Law LLC',
  description: 'Experienced legal representation in Xenia Municipal Court. Skilled representation for misdemeanor cases, OVI/DUI, and traffic violations in Greene County, Ohio. Schedule consultation: (614) 285-5482',
  keywords: ['Xenia Municipal Court attorney', 'Greene County OVI lawyer', 'Xenia misdemeanor defense'],
  openGraph: {
    title: 'Xenia Municipal Court Attorney | Jwayyed Law LLC',
    url: 'https://www.jjlawohio.com/courts/xenia-municipal-court',
  },
  alternates: { canonical: '/courts/xenia-municipal-court' },
};

const breadcrumbItems = [
  { label: 'Courts', href: '/courts' },
  { label: 'Greene County', href: '/courts/greene-county' },
  { label: 'Xenia Municipal Court', href: '/courts/xenia-municipal-court' },
];

const faqs = [
  {
    question: 'What types of cases does Xenia Municipal Court handle?',
    answer: 'Xenia Municipal Court handles misdemeanor criminal cases, OVI/DUI charges, traffic violations, civil disputes involving amounts up to $15,000, small claims matters, and landlord-tenant disputes occurring in Greene County. The court follows Ohio Revised Code for procedures and penalties.',
  },
  {
    question: 'Where is Xenia Municipal Court located?',
    answer: 'Xenia Municipal Court is located in Xenia, Ohio. The court handles all misdemeanor cases, OVI/DUI charges, and traffic violations occurring in Greene County. An attorney familiar with the court can help navigate procedures and achieve favorable outcomes.',
  },
  {
...
export default function XeniaMunicipalCourtPage() {
  return (
    <>
      <Breadcrumbs items={breadcrumbItems} />
      <PageHero
        title="Xenia Municipal Court Attorney"
        description="Experienced legal representation in Xenia Municipal Court. Serving Greene County, Ohio."
      />
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="font-['Playfair_Display',_'Georgia',_serif] text-3xl font-bold text-gray-900 mb-6">Xenia Municipal Court Representation</h2>
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Xenia Municipal Court in Xenia, Ohio, handles misdemeanor criminal cases, OVI/DUI charges, traffic violations, and civil disputes occurring in Greene County. At Jwayyed Law LLC, we provide experienced representation in Xenia Municipal Court under Ohio Revised Code. Our attorney understands Municipal Court procedures and can help achieve favorable outcomes.
            </p>

            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              The Xenia Municipal Court is located in Xenia, Ohio, and serves Greene County and surrounding communities. Municipal Court proceedings are less formal than Common Pleas Court but still require proper preparation and experienced representation. Understanding court procedures, filing requirements, and judicial preferences is essential for successful representation.
            </p>
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Our firm provides experienced representation in all types of cases handled by Xenia Municipal Court:
            </p>
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Our firm provides dedicated representation in Xenia Municipal Court. We understand that Municipal Court matters can significantly affect your rights, driving privileges, and future. Our attorney works diligently to navigate court procedures, develop strategies, negotiate settlements, and represent clients in court when necessary.
            </p>

            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              If you have a matter in Xenia Municipal Court, contact Jwayyed Law LLC for a schedule consultation. We will review your case, explain court procedures, discuss your options, and develop a strategy tailored to your situation. Understanding court procedures and having experienced representation can significantly impact the outcome of your case.
            </p>
          </div>
        </div>
      </section>
