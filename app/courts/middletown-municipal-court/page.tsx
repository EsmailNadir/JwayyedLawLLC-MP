...
export const metadata: Metadata = {
  title: 'Middletown Municipal Court Attorney | Butler County Lawyer | Jwayyed Law LLC',
  description: 'Experienced legal representation in Middletown Municipal Court. Skilled representation for misdemeanor cases, OVI/DUI, and traffic violations in Butler County, Ohio. Schedule consultation: (614) 285-5482',
  keywords: ['Middletown Municipal Court attorney', 'Butler County OVI lawyer', 'Middletown misdemeanor defense'],
  openGraph: {
    title: 'Middletown Municipal Court Attorney | Jwayyed Law LLC',
    url: 'https://www.jjlawohio.com/courts/middletown-municipal-court',
  },
  alternates: { canonical: '/courts/middletown-municipal-court' },
};

const breadcrumbItems = [
  { label: 'Courts', href: '/courts' },
  { label: 'Butler County', href: '/courts/butler-county' },
  { label: 'Middletown Municipal Court', href: '/courts/middletown-municipal-court' },
];

const faqs = [
  {
    question: 'What types of cases does Middletown Municipal Court handle?',
    answer: 'Middletown Municipal Court handles misdemeanor criminal cases, OVI/DUI charges, traffic violations, civil disputes involving amounts up to $15,000, small claims matters, and landlord-tenant disputes occurring in Butler County. The court follows Ohio Revised Code for procedures and penalties.',
  },
  {
    question: 'Where is Middletown Municipal Court located?',
    answer: 'Middletown Municipal Court is located in Middletown, Ohio. The court handles all misdemeanor cases, OVI/DUI charges, and traffic violations occurring in Butler County. An attorney familiar with the court can help navigate procedures and achieve favorable outcomes.',
  },
  {
...
export default function MiddletownMunicipalCourtPage() {
  return (
    <>
      <Breadcrumbs items={breadcrumbItems} />
      <PageHero
        title="Middletown Municipal Court Attorney"
        description="Experienced legal representation in Middletown Municipal Court. Serving Butler County, Ohio."
      />
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="font-['Playfair_Display',_'Georgia',_serif] text-3xl font-bold text-gray-900 mb-6">Middletown Municipal Court Representation</h2>
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Middletown Municipal Court in Middletown, Ohio, handles misdemeanor criminal cases, OVI/DUI charges, traffic violations, and civil disputes occurring in Butler County. At Jwayyed Law LLC, we provide experienced representation in Middletown Municipal Court under Ohio Revised Code. Our attorney understands Municipal Court procedures and can help achieve favorable outcomes.
            </p>

            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              The Middletown Municipal Court is located in Middletown, Ohio, and serves Butler County and surrounding communities. Municipal Court proceedings are less formal than Common Pleas Court but still require proper preparation and experienced representation. Understanding court procedures, filing requirements, and judicial preferences is essential for successful representation.
            </p>
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Our firm provides experienced representation in all types of cases handled by Middletown Municipal Court:
            </p>
