...
export const metadata: Metadata = {
  ...
  description: 'Experienced legal representation in Middletown Municipal Court. Skilled representation for misdemeanor cases, OVI/DUI, and traffic violations in Butler County, Ohio. Free consultation: (614) 285-5482',
