...
export const metadata: Metadata = {
  ...
  description: 'Experienced legal representation in Fairfield County courts including Common Pleas and Municipal Courts. Skilled representation in Fairfield County, Ohio. Free consultation: (614) 285-5482',
