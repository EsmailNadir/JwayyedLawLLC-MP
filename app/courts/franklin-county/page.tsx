...
export const metadata: Metadata = {
  ...
  description: 'Experienced legal representation in Franklin County courts including Common Pleas and Municipal Courts. Skilled representation in Columbus, Ohio. Schedule consultation: (614) 285-5482',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Franklin County courts in Columbus, Ohio, handle various legal matters including criminal cases, OVI/DUI charges, and civil disputes. At Jwayyed Law LLC, we provide experienced representation in Franklin County courts. In the Court of Common Pleas, we focus on civil litigation and domestic relations matters. In Municipal Court, we handle misdemeanor defense, OVI/DUI charges, traffic violations, and civil disputes. Please note that we do not handle immigration matters, juvenile matters, probate matters, or criminal defense and OVI/DUI cases in the Court of Common Pleas.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <Link href="/courts/franklin-county-court-of-common-pleas" className="block p-6 border border-gray-200 rounded-lg hover:border-orange-500 hover:shadow-md transition-all">
                ...
                <p className="text-sm text-gray-600 font-['Inter',_'Arial',_sans-serif]">Major civil disputes and domestic relations cases. No criminal defense, OVI/DUI, immigration, juvenile, or probate matters.</p>
              </Link>
