...
export const metadata: Metadata = {
  ...
  description: 'Experienced legal representation in Fairfield County Municipal Court. Skilled representation for misdemeanor cases, OVI/DUI, and traffic violations in Fairfield County, Ohio. Free consultation: (614) 285-5482',
