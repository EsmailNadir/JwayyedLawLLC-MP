...
export const metadata: Metadata = {
  ...
  description: 'Experienced legal representation in Franklin Municipal Court (Carlisle/Franklin). Skilled representation for misdemeanor cases, OVI/DUI, and traffic violations in Warren County, Ohio. Free consultation: (614) 285-5482',
