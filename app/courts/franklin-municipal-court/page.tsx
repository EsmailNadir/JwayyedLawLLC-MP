...
export const metadata: Metadata = {
  title: 'Franklin Municipal Court Attorney (Carlisle/Franklin) | Warren County Lawyer | Jwayyed Law LLC',
  description: 'Experienced legal representation in Franklin Municipal Court (Carlisle/Franklin). Skilled representation for misdemeanor cases, OVI/DUI, and traffic violations in Warren County, Ohio. Schedule consultation: (614) 285-5482',
  keywords: ['Franklin Municipal Court attorney', 'Carlisle Municipal Court lawyer', 'Warren County OVI lawyer'],
  openGraph: {
    title: 'Franklin Municipal Court Attorney (Carlisle/Franklin) | Jwayyed Law LLC',
    url: 'https://www.jjlawohio.com/courts/franklin-municipal-court',
  },
  alternates: { canonical: '/courts/franklin-municipal-court' },
};

const breadcrumbItems = [
  { label: 'Courts', href: '/courts' },
  { label: 'Warren County', href: '/courts/warren-county' },
  { label: 'Franklin Municipal Court (Carlisle/Franklin)', href: '/courts/franklin-municipal-court' },
];

const faqs = [
  {
    question: 'What types of cases does Franklin Municipal Court handle?',
    answer: 'Franklin Municipal Court (Carlisle/Franklin) handles misdemeanor criminal cases, OVI/DUI charges, traffic violations, civil disputes involving amounts up to $15,000, small claims matters, and landlord-tenant disputes occurring in Warren County. The court follows Ohio Revised Code for procedures and penalties.',
  },
  {
    question: 'Where is Franklin Municipal Court located?',
    answer: 'Franklin Municipal Court (Carlisle/Franklin) is located in Franklin, Ohio. The court handles all misdemeanor cases, OVI/DUI charges, and traffic violations occurring in Warren County. An attorney familiar with the court can help navigate procedures and achieve favorable outcomes.',
  },
  {
...
export default function FranklinMunicipalCourtPage() {
  return (
    <>
      <Breadcrumbs items={breadcrumbItems} />
      <PageHero
        title="Franklin Municipal Court Attorney (Carlisle/Franklin)"
        description="Experienced legal representation in Franklin Municipal Court. Serving Warren County, Ohio."
      />
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="font-['Playfair_Display',_'Georgia',_serif] text-3xl font-bold text-gray-900 mb-6">Franklin Municipal Court Representation</h2>
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Franklin Municipal Court (Carlisle/Franklin) in Franklin, Ohio, handles misdemeanor criminal cases, OVI/DUI charges, traffic violations, and civil disputes occurring in Warren County. At Jwayyed Law LLC, we provide experienced representation in Franklin Municipal Court under Ohio Revised Code. Our attorney understands Municipal Court procedures and can help achieve favorable outcomes.
            </p>

            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              The Franklin Municipal Court serves Warren County and surrounding communities including Carlisle and Franklin. Municipal Court proceedings are less formal than Common Pleas Court but still require proper preparation and experienced representation. Understanding court procedures, filing requirements, and judicial preferences is essential for successful representation.
            </p>
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Our firm provides experienced representation in all types of cases handled by Franklin Municipal Court:
            </p>
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Our firm provides dedicated representation in Franklin Municipal Court. We understand that Municipal Court matters can significantly affect your rights, driving privileges, and future. Our attorney works diligently to navigate court procedures, develop strategies, negotiate settlements, and represent clients in court when necessary.
            </p>

            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              If you have a matter in Franklin Municipal Court, contact Jwayyed Law LLC for a schedule consultation. We will review your case, explain court procedures, discuss your options, and develop a strategy tailored to your situation. Understanding court procedures and having experienced representation can significantly impact the outcome of your case.
            </p>
          </div>
        </div>
      </section>
