...
export const metadata: Metadata = {
  ...
  description: 'Experienced Columbus eviction attorney representing landlords and tenants. Skilled representation for eviction proceedings in Ohio. Free consultation: (614) 285-5482',
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Our firm provides dedicated eviction representation in Columbus, Franklin County, and throughout Ohio. We understand that eviction proceedings move quickly and can affect your housing and rights. Our attorney works diligently to handle eviction proceedings for landlords, defend tenants against eviction, and protect your rights throughout the process.
            </p>
