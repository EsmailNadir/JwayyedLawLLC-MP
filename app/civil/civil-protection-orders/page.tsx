        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              Our firm provides dedicated civil protection orders representation in Columbus, Franklin County, and throughout Ohio. We understand that protection order proceedings move quickly and can significantly affect your rights. Our attorney works diligently to help victims obtain protection orders and defend against protection orders to protect your rights.
            </p>
          </div>
        </div>
      </section>
