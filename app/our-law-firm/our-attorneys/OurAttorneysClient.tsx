...
export default function OurAttorneysClient() {
      ...
      <section className="py-14 sm:py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative min-h-[70vh]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 flex flex-wrap gap-3 font-['DM_Sans',_'Helvetica_Neue',_sans-serif]">
            ...
            <Link href="/our-law-firm/document-templates" className="text-[#b87333] hover:underline font-medium">Document Templates</Link>
