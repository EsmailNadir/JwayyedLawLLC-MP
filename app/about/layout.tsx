...
export const metadata: Metadata = {
  ...
  description: 'Meet Attorney Jwayyed Jwayyed — Ohio OVI, criminal defense, estate planning & business law. Former municipal prosecutor. Free consultation: (614) 285-5482.',
  keywords: [
    'Ohio attorney',
    'attorney Jwayyed',
    'attorney in Ohio',
