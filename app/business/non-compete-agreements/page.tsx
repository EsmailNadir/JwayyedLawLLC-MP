        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              Our firm provides dedicated non-compete agreements representation in Columbus, Franklin County, and throughout Ohio. We understand that non-compete agreements can significantly affect your ability to work. Our attorney works diligently to draft enforceable agreements, evaluate enforceability, negotiate terms, and protect your interests.
            </p>
          </div>
        </div>
      </section>
