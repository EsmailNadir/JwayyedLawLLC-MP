      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-6 leading-relaxed">
              Our firm provides dedicated business law representation in Columbus, Franklin County, and throughout Ohio. We understand that business matters require experienced representation. Our attorney works diligently to help businesses form, grow, and resolve disputes while protecting business interests and ensuring compliance.
            </p>
