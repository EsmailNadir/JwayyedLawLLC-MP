...
export const metadata: Metadata = {
  title: 'Shareholder Disputes Lawyer in Ohio | Columbus, Cincinnati, Dayton | Experienced Attorney | Jwayyed Law LLC',
  description: 'Experienced Ohio shareholder disputes attorney resolving corporate conflicts. Skilled representation for shareholder disputes in Ohio. Schedule consultation: (614) 285-5482',
  ...
  openGraph: {
    title: 'Shareholder Disputes Lawyer in Ohio | Columbus, Cincinnati, Dayton | Jwayyed Law LLC',
