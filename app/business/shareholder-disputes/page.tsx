        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              Our firm provides dedicated shareholder disputes representation in Columbus, Franklin County, and throughout Ohio. We understand that shareholder disputes can disrupt corporate operations. Our attorney works diligently to resolve disputes, protect shareholder rights, and achieve favorable outcomes for our clients.
            </p>
          </div>
        </div>
      </section>
