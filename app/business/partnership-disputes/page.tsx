        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              Our firm provides dedicated partnership disputes representation throughout Ohio. We understand that partnership disputes can disrupt business operations. Our attorney works diligently to resolve disputes, protect partnership interests, and achieve favorable outcomes for our clients.
            </p>
          </div>
        </div>
      </section>
