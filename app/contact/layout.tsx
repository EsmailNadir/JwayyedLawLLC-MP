...
export const metadata: Metadata = {
  ...
  description: 'Contact Jwayyed Law LLC serving Columbus, Cincinnati, Dayton, and throughout Ohio. Schedule a consultation. Office: 100 E. Campus View Boulevard, Suite #250, Columbus, OH. Call (614) 285-5482.',
  keywords: [
