...
export default function ArbitrationPage() {
  return (
    <>
      ...
      <PageHero
        title="Arbitration Lawyer in Columbus, OH"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              Our firm provides dedicated arbitration representation in Columbus, Franklin County, and throughout Ohio. We understand that arbitration can resolve disputes more efficiently than litigation while providing binding decisions. Our attorney works diligently to represent your interests effectively in arbitration proceedings.
            </p>
          </div>
        </div>
      </section>
