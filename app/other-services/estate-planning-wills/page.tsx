...
export const metadata: Metadata = {
  ...
  description: 'Experienced Ohio estate planning and wills attorney protecting your legacy. Skilled representation for wills and estate planning in Ohio. Schedule consultation: (614) 285-5482',
  ...
  openGraph: {
    title: 'Estate Planning & Wills Lawyer in Ohio | Columbus, Cincinnati, Dayton | Jwayyed Law LLC',
