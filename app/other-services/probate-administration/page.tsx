...
export default function ProbateAdministrationPage() {
  return (
    <>
      ...
      <PageHero
        title="Probate Administration Lawyer in Columbus, OH"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              Our firm provides dedicated probate administration assistance in Columbus, Franklin County, and throughout Ohio. We understand that probate can be complex and emotional. Our attorney works diligently to guide you through probate, ensure compliance with all requirements, and protect your interests.
            </p>
          </div>
        </div>
      </section>
