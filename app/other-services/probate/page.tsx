...
export const metadata: Metadata = {
  title: 'Probate Lawyer in Ohio | Columbus, Cincinnati, Dayton | Experienced Attorney | Jwayyed Law LLC',
  description: 'Experienced Ohio probate attorney serving Columbus, Cincinnati, Dayton, and throughout Ohio. Helping you navigate probate administration. Skilled representation for probate matters in Ohio. Schedule consultation: (614) 285-5482',
  keywords: ['probate lawyer Columbus OH', 'probate attorney Ohio', 'probate administration lawyer', 'Franklin County probate attorney'],
  openGraph: {
    title: 'Probate Lawyer in Ohio | Columbus, Cincinnati, Dayton | Jwayyed Law LLC',
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="font-['Inter',_'Arial',_sans-serif] text-gray-700 mb-8 leading-relaxed">
              Our firm provides dedicated probate assistance throughout Ohio. We understand that probate can be complex and emotional. Our attorney works diligently to guide you through probate, ensure compliance with all requirements, and protect your interests.
            </p>
          </div>
        </div>
      </section>
