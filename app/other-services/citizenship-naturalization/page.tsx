...
export const metadata: Metadata = {
  ...
  description: 'Experienced Ohio citizenship and naturalization attorney serving Columbus, Cincinnati, Dayton, and throughout Ohio. Helping you become a U.S. citizen. Skilled representation for citizenship applications in Ohio. Schedule consultation: (614) 285-5482',
  ...
  openGraph: {
    title: 'Citizenship & Naturalization Lawyer in Ohio | Columbus, Cincinnati, Dayton | Jwayyed Law LLC',
...
export default function CitizenshipNaturalizationPage() {
  return (
    <>
      ...
      <PageHero
        title="Ohio Citizenship & Naturalization Lawyer"
