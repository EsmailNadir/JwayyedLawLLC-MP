...
export const metadata: Metadata = {
  title: 'Deportation Defense Lawyer in Ohio | Columbus, Cincinnati, Dayton | Experienced Attorney | Jwayyed Law LLC',
  description: 'Experienced Ohio deportation defense attorney protecting your rights. Skilled representation for deportation proceedings in Ohio. Schedule consultation: (614) 285-5482',
  ...
  openGraph: {
    title: 'Deportation Defense Lawyer in Ohio | Columbus, Cincinnati, Dayton | Jwayyed Law LLC',
...
export default function DeportationDefensePage() {
  return (
    <>
      ...
      <PageHero
        title="Ohio Deportation Defense Lawyer"
