...
export const metadata: Metadata = {
  ...
  description: 'Experienced Ohio estate disputes attorney resolving conflicts. Skilled representation for estate distribution disputes in Ohio. Schedule consultation: (614) 285-5482',
  ...
  openGraph: {
    title: 'Estate Disputes Lawyer in Ohio | Columbus, Cincinnati, Dayton | Jwayyed Law LLC',
